...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex h-screen">
        {/* Sidebar */}
        <div className={`${sidebarOpen ? 'w-64' : 'w-0'} bg-linear-to-b from-red-900 to-red-800 text-white shadow-xl transition-all duration-300 ease-in-out overflow-hidden`}>
